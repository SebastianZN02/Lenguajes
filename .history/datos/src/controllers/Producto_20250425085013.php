...
class Producto
{
    ...
    public function create(Request $request, Response $response, $args) //Crea
    {
        ...
        public function update(Request $request, Response $response, $args) //Actualizar un producto
    {
        $body = json_decode($request->getBody());
        $sql = "INSERT INTO productos (";
