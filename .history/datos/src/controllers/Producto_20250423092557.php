...
class Producto
{
    ...
    public function create(Request $request, Response $response, $args)
    {
        ...
        $sql = "INSERT INTO productos (id, codigo_producto, precio_compra_producto,
                ...
                VALUES(:id, :codigo_producto, :precio_compra_producto, :precio_venta_producto,
                :utilidad, :fecha_creacion_producto)";
                /*($body['id'], $body['codigo_producto'], $body['precio_compra_producto'],
